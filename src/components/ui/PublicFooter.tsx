      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-10 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 pb-12 border-b border-outline-variant/10">
          ...
          <div className="space-y-4">
            <h3 className="font-headline font-black text-on-surface text-sm uppercase tracking-widest">
              Product
            </h3>
          ...
          <div className="space-y-4">
            ...
            <p className="font-body text-sm text-on-surface-variant">
              Get early access to secret events and curated drops.
            </p>
            <div className="flex gap-2">
              <input
                type="email"
                placeholder="your@email.com"
                className="flex-1 min-w-0 bg-surface-container-lowest border border-outline-variant/20 rounded-lg px-4 py-2.5 text-sm font-body text-on-surface placeholder:text-on-surface-variant/40 focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition-all"
              />
              <button
                type="button"
                className="px-4 py-2.5 bg-primary text-on-primary rounded-lg font-bold text-sm hover:opacity-90 active:scale-95 transition-all whitespace-nowrap"
              >
                Join
              </button>
            </div>
