...
import BookingManagementClient from '@/components/admin/support/BookingManagementClient';
    ...
    <div className="min-h-screen bg-surface px-10 py-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="flex flex-col gap-2 mb-10">
        ...
        <p className="text-xs uppercase tracking-widest text-slate-500 font-bold">
          Search, modify details, resend digital tickets, and issue administrative refunds or cancellations
        </p>
      </div>
